using Grpc.Core;using Grpc.Net.Client;using Microsoft.CognitiveServices.Speech;using Microsoft.Extensions.CommandLineUtils;using Microsoft.Extensions.Logging;using ntx20.api;using ntx20.api.io;using ntx20.api.pipe;using ntx20.api.proto;using ntx20.api.utils;using System;using System.Collections.Generic;using System.IO;using System.Linq;using System.Net.Http;using System.Threading;using System.Threading.Tasks;namespace ntx20.command.run{    class Command : ICommand    {        private static readonly ILogger _logger = Logging.LoggerFactory.CreateLogger("ntx20.command.run");
        ...
        { { "atran","ntx20" }, { "ppc","ntx20"  }, { "adsp","ntx20"  }, { "diar","ntx20"  }, { "vad","ntx20"  }, { "dtran","ntx20"  }, { "mstran","msft" } };
